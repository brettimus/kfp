...
create_users_query.on('end', function() {
    // make tuple table
    create_tuples_query = client.query('CREATE TABLE tuples (id serial PRIMARY KEY, names text[], descriptions text[], urls text[], pairings integer, creator_id integer references users(id));');
